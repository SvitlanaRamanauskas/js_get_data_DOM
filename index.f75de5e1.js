...
population.forEach((span)=>{
    ...
    if (!isNaN(populationNumber)) populationArr.push(populationNumber);
});
...
document.querySelector("span.total-population").textContent = separateNumberWithComas(totalPopulation);
document.querySelector("span.average-population").textContent = separateNumberWithComas(averagePopulation);
